...
def main():
    ...
    checkpoint_path= '/home/nacho/work/model_ckpts/Unimodal/Text/RoBERTa_DiffLR.ckpt'
    ...
    compute_metrics(validation_loader, predictions_val, 'val', 'RoBERTa512_DiffLR')
    compute_metrics(test_loader, predictions_test, 'test', 'RoBERTa512_DiffLR')
