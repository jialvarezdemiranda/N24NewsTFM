...
def main(checkpoint, num_tokens):
    ...
    checkpoint_path= '/home/nacho/work/model_ckpts/Unimodal/Text/LongFormerNoRegSameLR/Longformer_512_NoRegSameLR_repetidoParaCKPT.ckpt'
...
def compute_metrics(loader, predictions, split, ckpt):
    ...
    sys.stdout = open(f'../../../Val-TestResults/LongformerNoRegSameLR/Metrics/{ckpt}.txt', 'a')
...
def cfm(y_true, y_pred, split, ckpt):
    ...
    dir= f'../../../Val-TestResults/LongformerNoRegSameLR/CFM/{ckpt}'
    if not os.path.exists(dir):
        os.mkdir(dir)
    plt.savefig(f'../../../Val-TestResults/LongformerNoRegSameLR/CFM/{ckpt}/{split}.png')  
