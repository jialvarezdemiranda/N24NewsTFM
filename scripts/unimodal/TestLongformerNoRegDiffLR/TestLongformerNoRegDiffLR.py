...
def main(checkpoint, num_tokens):
    ...
    checkpoint_path= '/home/nacho/work/model_ckpts/Unimodal/Text/LongFormerNoRegDiffLR/Longformer_512_NoReg_DiffLR.ckpt'
...
def compute_metrics(loader, predictions, split, ckpt):
    ...
    sys.stdout = open(f'../../../Val-TestResults/LongformerNoRegDiffLR/Metrics/{ckpt}.txt', 'a')
...
def cfm(y_true, y_pred, split, ckpt):
    ...
    dir= f'../../../Val-TestResults/LongformerNoRegDiffLR/CFM/{ckpt}'
    if not os.path.exists(dir):
        os.mkdir(dir)
    plt.savefig(f'../../../Val-TestResults/LongformerNoRegDiffLR/CFM/{ckpt}/{split}.png')  
