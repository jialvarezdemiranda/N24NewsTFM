...
if __name__== '__main__': # For potential concurrency issues with dataloaders
    ...
    experiment_name=f'Longformer_{MAX_LENGTH}_NoRegSameLR_repetidoParaCKPT' # Longformer_{MAX_LENGTH}_NoReg_SameLR Longformer4096-NoRegSameLR
    # Define the callbacks
    checkpoint_callback = ModelCheckpoint(
        dirpath='../../model_ckpts/Unimodal/Text/LongFormerNoRegSameLR',
    ...
    logger = CSVLogger(save_dir="../../logs/Unimodal/Text/LongFormerNoRegSameLR", name=experiment_name)
