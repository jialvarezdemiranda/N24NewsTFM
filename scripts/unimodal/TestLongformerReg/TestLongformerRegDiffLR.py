...
def main(checkpoint, num_tokens):
    ...
    checkpoint_path= '/home/nacho/work/model_ckpts/Unimodal/Text/Longformer_1024_Reg_DiffLR.ckpt'
...
def compute_metrics(loader, predictions, split, ckpt):
    ...
    sys.stdout = open(f'../../../Val-TestResults/Unimodal/LongformerRegDiffLR/Metrics/{ckpt}.txt', 'a')
...
def cfm(y_true, y_pred, split, ckpt):
    ...
    dir= f'../../../Val-TestResults/Unimodal/LongformerRegDiffLR/CFM/{ckpt}'
    if not os.path.exists(dir):
        os.mkdir(dir)
    plt.savefig(f'../../../Val-TestResults/Unimodal/LongformerRegDiffLR/CFM/{ckpt}/{split}.png')  
